...
# run over files
process.calcrespcorrphotonplusjet.rootHistFilename = cms.string('PhoJet_tree_RelValTT_PU50ns.root')
...
process.calcrespcorrphotonplusjet.photonTriggers = cms.vstring()
process.calcrespcorrphotonplusjet.pfJetCollName = cms.string('ak4PFJets')
#process.calcrespcorrphotonplusjet.pfJetCollName = cms.string('ak5PFJetsL1') # L1 corrected jet? # needs production
process.calcrespcorrphotonplusjet.pfJetCorrName = cms.string('ak4PFL2L3')
...
listFileName='fileInfo_7_1_10_patch2_RelValZTT_13_MCRUN2.txt'
listFileName='fileInfo_7_1_10_patch2_RelValZTT_13_MCRUN2_PU25ns.txt'
listFileName='fileInfo_7_1_10_patch2_RelValZTT_13_MCRUN2_PU50ns.txt'
...
#readFiles=cms.untracked.vstring('file:selection_RelValTT_noPU.root')
